...
export class KhoaService {
    static async getAllKhoa(params?: IParamKhoa) {
        return await authApi.get(`${API.KHOA.GET_ALL}`,{
            params: params
        })
        .then(response => ({
            data: response.data,
    ...
    static async getAllKhoaServer(params?: IParamKhoa) {
        return await authApiServer.get(`${API.KHOA.GET_ALL}`,{
            params: params
        })
        .then(response => ({
            data: response.data,
    ...
    static async getKhoaById(id: string | number | null) {
        return await authApi.get(`${API.KHOA.GET_BY_ID}`.replace(':id', `${id}`))
            .then(response => response.data)
            .catch(error => error.response?.data);
    }
    static async getKhoaByIdServer(id: string | number | null) {
        return await authApiServer.get(`${API.KHOA.GET_BY_ID}`.replace(':id', `${id}`))
            .then(response => response.data)
            .catch(error => error.response?.data);
    }
