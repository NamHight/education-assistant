...
export class LichBieuService {
    static async getLichBieu(params: IParamLichBieu) {
        return await authApi.get(`${API.LICH_BIEU.GET_ALL}`, {
            params: params
        }).then((response) => {
    ...
    static async getLichBieuServer(params: IParamLichBieu) {
        return await authApiServer.get(`${API.LICH_BIEU.GET_ALL}`, {
            params: params
        }).then((response) => {
            return Promise.resolve({
                data: response.data,
    ...
    static async getLichBieuByKhoa(params: IParamLichBieu) {
        return await authApi.get(`${API.LICH_BIEU.GET_ALL_BY_NO_PAGE}`, {
            params: params
        })
    ...
    static async getLichBieuById(id: string | number | null) {
        return await authApi.get(`${API.LICH_BIEU.GET_BY_ID}`.replace(':id', `${id}`))
            .then(response => response.data)
            .catch(error => error.response?.data);
    }

    static async getLichBieuByIdServer(id: string | number | null) {
        return await authApiServer.get(`${API.LICH_BIEU.GET_BY_ID}`.replace(':id', `${id}`))
            .then(response => response.data)
            .catch(error => error.response?.data);
    }
