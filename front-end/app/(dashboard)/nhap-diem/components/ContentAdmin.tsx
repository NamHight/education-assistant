...
const ContentAdmin = ({ queryKey }: ContentProps) => {
  ...
  const { data, isLoading, isFetching } = useQuery({
    queryKey: [
      ...
      filterOption.hocKy,
      filterOption.khoaId,
      filterOption.loaiChuongTrinhDaoTao
    ],
    queryFn: async () => {
      ...
      <Box className='flex justify-end w-full gap-4 border border-gray-200 rounded-lg p-4 shadow-sm'>
        <Box className='flex items-center gap-3 w-full'>
          <Grid container className='w-full flex items-center gap-2' spacing={1}>
            <Grid size={2}>
              <Typography className='!font-semibold !text-gray-700'>Bậc</Typography>
            </Grid>
            <Grid size={10}>
              <InputSelect2
                fullWidth
          ...
          <Grid container className='w-full flex items-center gap-2'>
            <Grid size={2}>
              <Typography className='!font-semibold !text-gray-700'>Khoa</Typography>
            </Grid>
            <Grid size={10}>
              <InputSelect2
                fullWidth
          ...
          <Grid container className='w-full flex items-center gap-2'>
            <Grid size={2}>
              <Typography className='!font-semibold !text-gray-700'>Học kỳ</Typography>
            </Grid>
            <Grid size={10}>
              <InputSelect2
                fullWidth
