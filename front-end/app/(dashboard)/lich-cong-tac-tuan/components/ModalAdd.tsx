...
const ModalAdd = ({ open, handleClose, queryKey }: ModalAddProps) => {
  ...
  const schema = useMemo(() => {
    return yup.object().shape({
      TietBatDau: yup.number().typeError('Tiết bắt đầu phải là số').required('Tiết bắt đầu là bắt buộc'),
      TietKetThuc: yup.number().typeError('Tiết kết thúc phải là số').required('Tiết kết thúc là bắt buộc'),
